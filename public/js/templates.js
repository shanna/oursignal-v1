(function() {
  ...
  this.oursignal.templates['meta'] = function(context) {
    return (function() {
      ...
      $o = [];
      $o.push("<header>\n  <h1>\n    <a href='" + ($e($c(this.url))) + "' target='_blank' rel='external'>" + ($e($c(this.title))) + "</a>\n  </h1>\n</header>\n<div class='screenshot'>\n  <a href='" + ($e($c(this.url))) + "' target='_blank' rel='external'>\n    <img src='screenshots/" + this.id + ".png' title='" + ($e($c(this.title))) + "' width='336' height='216'>\n  </a>\n</div>\n<aside>\n  <h2>\n    <a href='http://" + this.domain + "' target='_blank' rel='external'>" + ($e($c(this.domain))) + "</a>\n  </h2>\n  <abbr class='retrieved_at' title='" + ($e($c(this.retrieved_at))) + "'>\n  <time datetime='" + ($e($c(this.retrieved_at))) + "'>" + ($p($e($c(this.retrieved_at)))) + "</time>\n  </abbr>\n  <table class='sources'>\n    <caption>Sources</caption>\n    <tbody>");
      _ref2 = this.sources;
      for (domain in _ref2) {
        url = _ref2[domain];
        $o.push("      <tr>\n        <td>\n          <a href='" + ($e($c(url))) + "' target='_blank' rel='external'>" + ($e($c(domain))) + "</a>\n        </td>\n      </tr>");
      }
