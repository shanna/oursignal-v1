...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/stateless-systems-capistrano-ext-0.12.3/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/stateless-systems-capistrano-ext-0.12.3/lib")
  ...
  @bundled_specs["stateless-systems-capistrano-ext"] = eval(File.read("#{dir}/specifications/stateless-systems-capistrano-ext-0.12.3.gemspec"))
  @bundled_specs["stateless-systems-capistrano-ext"].loaded_from = "#{dir}/specifications/stateless-systems-capistrano-ext-0.12.3.gemspec"
