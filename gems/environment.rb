...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/stateless-systems-capistrano-ext-0.11.0/lib")
  ...
  @bundled_specs["stateless-systems-capistrano-ext"].loaded_from = "#{dir}/specifications/stateless-systems-capistrano-ext-0.11.0.gemspec"
