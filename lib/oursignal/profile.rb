...
module Oursignal
  module Profile
    ...
    class << self
      ...
      def create options = {}
        user = Oursignal::User.create options
      ...
      def authenticate identifier, password
        Oursignal::User.first 'password = ? and (username = ? or email = ?)', digest_password(password), identifier, identifier
      end
      ...
      def search identifier
        Oursignal::User.first 'username = ? or email = ?', identifier, identifier
      end
